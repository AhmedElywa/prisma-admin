...
export function getRelationType(field: AdminField): RelationType | null {
  ...
  if (field.list) {
    ...
    return field.relationFrom ? 'one-to-many' : 'many-to-many';
  }
...
export function applyRelationDefaults(
  ...
  return {
    ...field,
    relationDisplayMode:
      field.relationDisplayMode || defaults.relationDisplayMode,
    ...
    relationEditOptions:
      field.relationEditOptions || defaults.relationEditOptions,
