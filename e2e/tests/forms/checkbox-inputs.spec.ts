...
test.describe('Checkbox and Toggle Fields', () => {
  ...
  test('should display checkbox fields', async ({ page }) => {
    ...
    if (await checkbox.isVisible()) {
      ...
      const label = formPage.form.locator(
  ...
  test('should display as toggle switch if styled', async ({ page }) => {
    ...
    const toggleSwitch = formPage.form
      .locator('[role="switch"], .toggle-switch, [class*="switch"]')
      .first();
  ...
  test('should show visual feedback on hover/focus', async ({ page }) => {
    ...
    if (await checkbox.isVisible()) {
      // Get initial style
      const _initialStyle = await checkbox.evaluate((el) => {
  ...
  test('should work in checkbox groups', async ({ page }) => {
    ...
    const checkboxGroup = formPage.form.locator(
  ...
  test('should validate required checkboxes', async ({ page }) => {
    ...
    const requiredCheckbox = formPage.form
      .locator(
  ...
  test('should handle disabled state', async ({ page }) => {
    ...
    const disabledCheckbox = formPage.form
  ...
  test('should announce state changes to screen readers', async ({ page }) => {
    ...
    if (await checkbox.isVisible()) {
      ...
      const labelText = await formPage.form
        .locator(`label[for="${await checkbox.getAttribute('id')}"]`)
        .textContent();
  ...
  test('should handle custom checkbox designs', async ({ page }) => {
    ...
    const customCheckbox = formPage.form
      .locator('.custom-checkbox, [class*="checkbox"]:not(input)')
      .first();
  ...
  test('should support three-state checkboxes if implemented', async ({
    page,
  }) => {
    // Some apps have three-state checkboxes (unchecked, checked, mixed)
    const triStateCheckbox = formPage.form
      .locator('[aria-checked="mixed"]')
      .first();
