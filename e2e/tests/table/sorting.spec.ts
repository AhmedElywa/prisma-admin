...
test.describe('Table Sorting', () => {
  ...
  test('should show sort direction indicator', async ({ page }) => {
    ...
    const ascIcon = emailHeader.locator(
      '[aria-label*="ascending"], [class*="asc"], svg[class*="up"]'
    );
    ...
    const descIcon = emailHeader.locator(
      '[aria-label*="descending"], [class*="desc"], svg[class*="down"]'
    );
  ...
  test('should clear sort on third click', async ({ page }) => {
    ...
    const sortIndicators = emailHeader.locator(
      '[aria-label*="sort"], [class*="sorted"]'
    );
  ...
  test('should sort numeric columns correctly', async ({ page }) => {
    ...
    // Sort by views
    const viewsHeader = listPage.table
      .locator('th')
    ...
    for (let i = 0; i < rowCount; i++) {
      ...
      views.push(Number.parseInt(viewText, 10) || 0);
    }
  ...
  test('should sort date columns correctly', async ({ page }) => {
    ...
    const createdHeader = listPage.table
      .locator('th')
