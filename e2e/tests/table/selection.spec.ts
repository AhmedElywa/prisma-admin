...
test.describe('Table Selection', () => {
  ...
  test('should select individual row', async ({ page }) => {
    ...
    // Check it's selected
    const firstRowCheckbox = listPage.tableRows
      .nth(0)
  ...
  test('should select all rows', async ({ page }) => {
    ...
    const rowCount = await listPage.getRowCount();
    for (let i = 0; i < rowCount; i++) {
      const checkbox = listPage.tableRows
        .nth(i)
        .locator('input[type="checkbox"]');
  ...
  test('should show indeterminate state for partial selection', async ({
    page,
  }) => {
    ...
    const selectAllState = await listPage.bulkSelectAll.evaluate(
  ...
  test('should maintain selection when sorting', async ({ page }) => {
    ...
    // Sort by email
    const emailHeader = listPage.table
      .locator('th')
  ...
  test('should select range with shift+click', async ({ page }) => {
    ...
    const row3Checkbox = listPage.tableRows
      .nth(3)
      .locator('input[type="checkbox"]');
  ...
  test('should toggle selection with ctrl/cmd+click', async ({ page }) => {
    ...
    const row0Checkbox = listPage.tableRows
      .nth(0)
      .locator('input[type="checkbox"]');
    const row2Checkbox = listPage.tableRows
      .nth(2)
      .locator('input[type="checkbox"]');
    ...
    const row1Checkbox = listPage.tableRows
      .nth(1)
      .locator('input[type="checkbox"]');
  ...
  test('should be keyboard accessible', async ({ page }) => {
    ...
    const firstCheckbox = listPage.tableRows
      .nth(0)
      .locator('input[type="checkbox"]');
    ...
    const isCheckbox = await focusedElement.evaluate(
